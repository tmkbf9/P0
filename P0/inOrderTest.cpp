...
void test_traversing_pre_order_empty_tree_should_output_nothing() {
...
void test_traversing_pre_order_root_should_output_root_data() {
    ostringstream logFile;
...
void test_traversing_pre_order_to_left_should_output_both() {
    ostringstream logFile;
...
void test_traversing_pre_order_to_right_should_output_both() {
    ostringstream logFile;
...
int main(int argc, char** argv) {
    test_traversing_pre_order_empty_tree_should_output_nothing();
    test_traversing_pre_order_root_should_output_root_data();
    test_adding_same_node_twice_at_root_displays_strings_in_FIFO_order();
    test_traversing_pre_order_to_left_should_output_both();
    test_traversing_pre_order_to_right_should_output_both();
